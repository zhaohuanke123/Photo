...
public class DragSelectRecyclerView extends RecyclerView {
    ...
    public boolean setDragSelectActive(boolean active, int initialSelection) {
        ...
        adapter.setSelected(initialSelection, !adapter.contains(initialSelection));
    ...
    /**
     * @param from - The index of the item that the finger is currently on
     * @param to   - The index of the item that the finger is moving to
     * @param min  - The minimum index that has been selected
     * @param max  - The maximum index that has been selected
     */
    private void selectRange(int from, int to, int min, int max) {
        String TAG = "DragSelectRecyclerView";
